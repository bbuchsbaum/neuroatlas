...
[TemplateFlow](httpsa://www.templateflow.org/) is a repository of curated neuroimaging templates and atlases, accessible via a Python client. The `neuroatlas` package provides an R interface to TemplateFlow, allowing you to easily discover, download, and use these resources within your R workflows.
...
# Ensure Python and the 'templateflow' Python module are available
...
#   
# } else {
#   message("Python or templateflow module not available. Skipping live TemplateFlow examples.")
# }
```
...
# print(mni_t1w) 
# This will attempt to download and return a neuroim2::NeuroVol object.
```
...
#   space = "MNI152NLin2009cAsym",
#   desc = "brain", # Often 'brain' for brain masks
#   suffix = "mask",
#   resolution = "1"
# )
...
# #> [1] "1" "2"
# # print(t1_multi_res[["1"]]) # Access the 1mm NeuroVol
```
...
#   # resolution can be used for some templates like fsaverage variants
# )
...
For more details on TemplateFlow itself, including the full range of available templates and BIDS-inspired naming conventions, please visit the [TemplateFlow website](httpsa://www.templateflow.org/). 