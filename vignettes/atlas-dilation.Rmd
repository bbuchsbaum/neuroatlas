...
The same sweep is easier to understand if you look at the ROIs themselves. On
this axial slice, white voxels are still unlabelled and coloured voxels carry
their Schaefer parcel label. As the radius increases, parcels fill more of the
nearby grey matter, including the same subcortical-adjacent territory that makes
large-radius whole-GM dilation risky.

```{r fig-radius-rois, echo = FALSE, eval = TRUE, out.width = "100%", fig.alt = "Four axial panels comparing Schaefer parcel labels before dilation and after radius-one, radius-four, and radius-six dilation on the same z equals 40 slice."}
knitr::include_graphics("figures/dilation-radius-rois.png")
```
